...
public static class ArraySorts
{
    ...
    public static Func<int[], int[]> BubbleSortFunc
        => (int[] a) => a.BubbleSort();
    public static Func<int[], int[]> InsertionSortFunc
        => (int[] a) => a.InsertionSort();
    public static Func<int[], int[]> SelectionSortFunc
        => (int[] a) => a.SelectionSort();
    public static Func<int[], int[]> QuickSortFunc
        => (int[] a) => a.QuickSort();
    public static Func<int[], int[]> MergeSortFunc
        => (int[] a) => a.MergeSort();
    public static Func<int[], int[]> HeapSortFunc
        => (int[] a) => a.HeapSort();
